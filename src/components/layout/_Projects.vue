...
<template>
      <div class="projects-section px-5" id="/*">
        <h2 class="mb-4">Projects</h2>
            ...
            <a @mouseenter="showOverlay" @mouseleave="hideOverlay" target="_blank" href="https://tender-feynman-0a5def.netlify.app/" class="project">
              <div class="project-overlay d-none d-md-flex"></div>
            ...
            <a @mouseenter="showOverlay" @mouseleave="hideOverlay" target="_blank" href="https://heuristic-newton-d525bc.netlify.app/" class="project">
              <div class="project-overlay d-none d-md-flex"></div>
            ...
            <a @mouseenter="showOverlay" @mouseleave="hideOverlay" target="_blank" href="https://affectionate-booth-7c6f42.netlify.app/" class="project">
              <div class="project-overlay d-none d-md-flex"></div>
